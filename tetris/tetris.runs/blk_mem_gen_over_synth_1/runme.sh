...
HD_PWD='C:/Users/csy/Desktop/Study/Logic2024/tetris/tetris/tetris.runs/blk_mem_gen_over_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log blk_mem_gen_over.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source blk_mem_gen_over.tcl
